...
public class WordokuFV1 {
    ...
    public static void printRules()/*Prints the rules.*/
    {
        ...
        Scanner scan=new Scanner(System.in);
        clearScreen();
        System.out.println("Press 0: To Exit \t\t\t\t\t\t\t\t\t\t\t\t      Press 1: To Play");
        System.out.print("\n\t\t\t\t\t\t\t<<<<<<<<<<<<<<<<<<<<<<<\n");
    ...
    public static void displayPuzzle(char[][] wordoku, char[] toBeFilled)/*prints the puzzle*/
    {
        ...
        System.out.println("Press 0: To Exit]\t\t\t\t\t   [Press 1: To Submit]\t\t\t\t\t    [Press 2: To Reset");
        System.out.print("\n");
        System.out.print("\t\t\t\t   Use only these Alphabets to solve: "+Arrays.toString(toBeFilled)+"\n\n\n");
    ...
    public static void displayEndScreen(char[][] wordoku, char[] toBeFilled)/*prints the puzzle*/
    {
        ...
        int columns = 10;//to form a pattern and display the puzzle
        int lines = 9;//to form a pattern and display the puzzle
        System.out.println("Press 0: To Exit\t\t\t\t\t\t\t\t\t\t\t       Press 1: For New Puzzle");
        System.out.print("\n");
        System.out.print("\t\t\t\t   Use only these Alphabets to solve: "+Arrays.toString(toBeFilled)+"\n\n\n");
    ...
    public static void checkWordoku()/*To check wordoku*/
    {
        ...
        for (int i = 0; i < 9; i++)/*To check rows*/
        {
            ...
            if (Arrays.compare(ary, row) != 0) /*Compare both the sorted arrays to check validity*/
                {
                    displayPuzzle(wordoku,toBeFilled);
                    System.out.print("\t\t\t\t\t    OOPS! LOOKS LIKE YOU MADE A MISTAKE IN ROW-" + tempRowCounter);
        ...
        for (int i = 0; i < 9; i++) /*To check columns*/
        {
            ...
            {
                displayPuzzle(wordoku,toBeFilled);
                System.out.print("\t\t\t\t\t OOPS! LOOKS LIKE YOU MADE A MISTAKE IN COLUMN-" + tempColumnCounter);
                System.out.print("\n\t\t\t\t\t\t  PRESS ANY CHARACTER TO CONTINUE..\n");
                scan.next();
                inputSystem();
            }
        ...
        {
            displayPuzzle(wordoku,toBeFilled);
            System.out.print("\t\t\t\t\t    OOPS! LOOKS LIKE YOU MADE A MISTAKE IN BOX-1");
            System.out.print("\n\t\t\t\t\t\t  PRESS ANY CHARACTER TO CONTINUE..\n");
            scan.next();
            inputSystem();
        }
        ...
        {
            displayPuzzle(wordoku,toBeFilled);
            System.out.print("\t\t\t\t\t    OOPS! LOOKS LIKE YOU MADE A MISTAKE IN BOX-2");
            System.out.print("\n\t\t\t\t\t\t  PRESS ANY CHARACTER TO CONTINUE..\n");
            scan.next();
            inputSystem();
        }
        ...
        {
            displayPuzzle(wordoku,toBeFilled);
            System.out.print("\t\t\t\t\t    OOPS! LOOKS LIKE YOU MADE A MISTAKE IN BOX-3");
            System.out.print("\n\t\t\t\t\t\t  PRESS ANY CHARACTER TO CONTINUE..\n");
            scan.next();
            inputSystem();
        }
        ...
        {
            displayPuzzle(wordoku,toBeFilled);
            System.out.print("\t\t\t\t\t    OOPS! LOOKS LIKE YOU MADE A MISTAKE IN BOX-4");
            System.out.print("\n\t\t\t\t\t\t  PRESS ANY CHARACTER TO CONTINUE..\n");
            scan.next();
            inputSystem();
        }
        ...
        {
            displayPuzzle(wordoku,toBeFilled);
            System.out.print("\t\t\t\t\t    OOPS! LOOKS LIKE YOU MADE A MISTAKE IN BOX-5");
            System.out.print("\n\t\t\t\t\t\t  PRESS ANY CHARACTER TO CONTINUE..\n");
            scan.next();
            inputSystem();
        }
        ...
        {
            displayPuzzle(wordoku,toBeFilled);
            System.out.print("\t\t\t\t\t    OOPS! LOOKS LIKE YOU MADE A MISTAKE IN BOX-6");
            System.out.print("\n\t\t\t\t\t\t  PRESS ANY CHARACTER TO CONTINUE..\n");
            scan.next();
            inputSystem();
        }
        ...
        {
            displayPuzzle(wordoku,toBeFilled);
            System.out.print("\t\t\t\t\t    OOPS! LOOKS LIKE YOU MADE A MISTAKE IN BOX-7");
            System.out.print("\n\t\t\t\t\t\t  PRESS ANY CHARACTER TO CONTINUE..\n");
            scan.next();
            inputSystem();
        }
        ...
        {
            displayPuzzle(wordoku,toBeFilled);
            System.out.print("\t\t\t\t\t    OOPS! LOOKS LIKE YOU MADE A MISTAKE IN BOX-8");
            System.out.print("\n\t\t\t\t\t\t  PRESS ANY CHARACTER TO CONTINUE..\n");
            scan.next();
            inputSystem();
        }
        ...
        {
            displayPuzzle(wordoku,toBeFilled);
            System.out.print("\t\t\t\t\t    OOPS! LOOKS LIKE YOU MADE A MISTAKE IN BOX-9");
            System.out.print("\n\t\t\t\t\t\t  PRESS ANY CHARACTER TO CONTINUE..\n");
            scan.next();
            inputSystem();
        }
        ...
        System.out.println("\t\t\t\t  CONGRATULATIONS! YOU JUST SOLVED A WORDOKU PUZZLE.. NICE WORK!!!");
        System.out.print("\n\t\t\t\t\t\t\t\tEnter: ");
        try
        {
            n = scan.nextInt();/*To continue flow of the program*/
